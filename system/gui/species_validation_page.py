...
class BackgroundUpdateThread(QThread):
    ...
    def run(self):
        ...
        import os
        from datetime import datetime
        from system.detection_db import get_db_path, upsert_detection, init_db, upsert_validation_bulk, delete_validation_bulk
        ...
        try:
            ...
            with sqlite3.connect(db_path) as conn:
                ...
                for task in self.update_tasks:
                    ...
                    if changed:
                        upsert_detection(db_path, base_name, file_name, detection_info)
                        if source_db_path:
                            upsert_detection(source_db_path, base_name, file_name, detection_info)
...
class SpeciesValidationPage(QWidget):
    ...
    def _update_json_file(self, file_name, new_species=None,
        ...
        from system.detection_db import get_db_path, upsert_detection, init_db
