...
- `POST /api/jobs` starts a folder processing job. By default it performs fast metadata indexing. Set `options.enable_detection` to `true` to load YOLO and run image inference.
